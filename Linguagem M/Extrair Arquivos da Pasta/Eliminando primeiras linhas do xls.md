...
```m
let
Fonte0 = Folder.Files("C:\Users\Rafael\Desktop\Rafael\Freelancer\Projeto Educação\SIAFE"), //Local da pasta com os arquivos XLS
Navegacao = Fonte0{0}[Content],
Amostra = Navegacao meta [IsParameterQuery=true, BinaryIdentifier=Navegacao, Type="Binary", IsParameterQueryRequired=true], //configurando a Extração
    ...
    Extracao = (Amostra) => let //Função da Extração dos dados
        ...
        #"Planilha 1" = Fonte1{[Name="Planilha 1"]}[Data] //selecionando somente a Planilha1 de cada arquivo
    in
        #"Planilha 1",
         Fonte3 = Folder.Files("C:\Users\Rafael\Desktop\Rafael\Freelancer\Projeto Educação\SIAFE"), //Local da pasta com os arquivos XLS
    #"Arquivos Ocultos Filtrados1" = Table.SelectRows(Fonte3, each [Attributes]?[Hidden]? <> true), // Filtra arquivos ocultos
